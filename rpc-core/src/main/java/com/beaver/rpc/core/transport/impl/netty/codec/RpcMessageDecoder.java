package com.beaver.rpc.core.transport.impl.netty.codec;

import com.beaver.rpc.core.compressor.Compressor;
import com.beaver.rpc.core.serializer.Serializer;
...
public class RpcMessageDecoder extends LengthFieldBasedFrameDecoder {
    ...
    private Object decodeFrame(ByteBuf in) {
        ...
        if (bodyLength > 0) {
            ...
            Compressor compress = ExtensionLoader.getExtensionLoader(Compressor.class)
                    .getExtension(compressName);
            bs = compress.decompress(bs);
            // deserialize the object
            String codecName = SerializationTypeEnum.getName(rpcMessage.getSerializer());
